    ...
    jQuery(document).ready(function() {
        ...
        $(".investment__plan__slider")
            ...
            .slick({
                ...
                slidesToScroll: 1,
                arrows: true,
                prevArrow: "<button type='button' class='slick-prev pull-left button arrow--button'><img src=\"assets/images/icons/right-arrow.png\" alt=\"Previous Plan\" /></button>",
                nextArrow: "<button type='button' class='slick-next pull-right button arrow--button'><img src=\"assets/images/icons/left-arrow.png\" alt=\"Next Plan\" /></button>",
                dots: false,
                responsive: [{
                        breakpoint: 1400,
                        settings: {
