...
(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        $(".range__slider").on("input", function() {
            ...
            $("#dailyProfit").html(((($(this).val() * 1.7) / 100) * 1).toFixed(4));
            $("#totalProfit").html(((($(this).val() * 1.7) / 100) * 120).toFixed(4));
        });
        ...
        $("#dailyProfit").html(function() {
            $("#dailyProfit").html(
                ((($(".range__slider").val() * 1.7) / 100) * 1).toFixed(4)
            );
        });

        $("#totalProfit").html(function() {
            $("#totalProfit").html(
                ((($(".range__slider").val() * 1.7) / 100) * 120).toFixed(4)
            );
        });
        ...
        $(".magic__filter").on("click", function() {
            ...
            var random5 = Math.floor(Math.random() * (70 - 40) + 40);
            var random6 = Math.floor(Math.random() * (80 - 70) + 70);
            var random7 = Math.floor(Math.random() * (100 - 80) + 80);
